    ...
    <MainLayout>
      <div className="container py-8">
        <div className="flex items-center gap-2 mb-6">
          <FileText className="h-8 w-8 text-shop-primary" />
        ...
        <div className="prose max-w-none space-y-8 text-muted-foreground">
          <section>
            <p>
              ...
              or usage of domain name [Enter domain name] (“Website”), including the related mobile
              site and mobile application (hereinafter 3 referred to as “Platform”). The Platform is
              owned by (Enter name of the company), a company incorporated under the Companies
              Act, 1956 with its registered office at (Enter Address) (hereinafter referred to as
