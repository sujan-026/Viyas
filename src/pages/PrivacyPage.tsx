      ...
      <div className="container py-8">
        ...
        <div className="prose max-w-none space-y-8 text-muted-foreground">
          <section>
            ...
            <p>
              This Privacy Policy describes how Viyas Connecting India and its affiliates (collectively "Viyas", "we", "our", "us") collect, use, share, protect or otherwise process your information/personal data through our website <a href="https://viyas.com" className="text-shop-primary underline" target="_blank" rel="noopener noreferrer">https://viyas.com</a> (hereinafter referred to as "Platform").
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              If you receive an email or a call from a person/association claiming to be seeking any personal data like debit/credit card PIN, net-banking or mobile banking password, we request you to never provide such information. If you have already revealed such information, report it immediately to an appropriate law enforcement agency.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              If you have any questions about this Privacy Policy, or wish to exercise your rights or withdraw your consent, please contact us at <a href="mailto:privacy@viyas.com" className="text-shop-primary underline">privacy@viyas.com</a> or through our Contact page.
            </p>
          </section>
        </div>
      </div>
